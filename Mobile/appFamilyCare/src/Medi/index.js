...
import { View, Text, StyleSheet, FlatList, TouchableOpacity, Modal, TextInput, CheckBox } from 'react-native';
      ...
      <Modal visible={modalVisible} transparent animationType="slide">
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            />
            <TouchableOpacity style={styles.modalButton} onPress={adicionarRemedio}>
