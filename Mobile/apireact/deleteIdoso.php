...
try {
    // Excluir idoso (as foreign keys com CASCADE irão excluir automaticamente os registros relacionados)
    ...
    echo json_encode(['status' => 'erro', 'mensagem' => 'Erro ao excluir idoso']);
}
?> 