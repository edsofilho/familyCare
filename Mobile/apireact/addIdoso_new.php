...
if (empty($nome) || !$idade || empty($sexo) || !$altura || !$peso || empty($carteiraSUS) || empty($contatoEmergenciaNome) || empty($contatoEmergenciaTelefone) || empty($telefone) || empty($email) || empty($senha) || !$familiaId) {
